...
Run (from python/, UTF-8):  python gen_before_after.py
Out: docs/week09/deck/assets/shots/report-after.png + report-before.png
(The week09 deck sources are not committed to this repo; the folder is created on run.)
"""
...
HERE = Path(__file__).resolve().parent          # <repo>/python
REPO = Path(__file__).resolve().parents[1]      # <repo> (repo root)
...
out = REPO / "docs" / "week09" / "deck" / "assets" / "shots"
